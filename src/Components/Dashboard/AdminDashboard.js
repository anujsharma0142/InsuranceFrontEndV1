...
import AgentContent from './Cards/AdminCards/AgentContent';
import InsuranceContent from './Cards/AdminCards/InsuranceContent';
import AccountContent from './Cards/AdminCards/AccountContent';
import SettingsContent from './Cards/AdminCards/SettingsContent';
import QueriesContent from './Cards/AdminCards/QueriesContent';
          ...
          <Drawer variant="permanent" open={open}>
            ...
            <List>
                ...
                <ListItem className={`${(tabValue == '2') ? 'highlightTab text-primary' : ''}`} disablePadding sx={{ display: 'block' }} onClick={() => handleDrawerLinks("2")}>
                  <ListItemButton sx={{ minHeight: 48, justifyContent: open ? 'initial' : 'center', px: 1.5 }}>
                    <ListItemIcon sx={{ minWidth: 0, mr: open ? 2 : 'auto', justifyContent: 'center' }}>
                      <UserOutlined className={`${(tabValue == '2') ? 'text-primary' : ''}`} />
                    </ListItemIcon>
                ...
                <ListItem className={`${(tabValue == '3') ? 'highlightTab text-primary' : ''}`} disablePadding sx={{ display: 'block' }} onClick={() => handleDrawerLinks("3")}>
                  <ListItemButton sx={{ minHeight: 48, justifyContent: open ? 'initial' : 'center', px: 1.5 }}>
                    <ListItemIcon sx={{ minWidth: 0, mr: open ? 2 : 'auto', justifyContent: 'center' }}>
                      <AccountBookOutlined  className={`${(tabValue == '3') ? 'text-primary' : ''}`} />
                    </ListItemIcon>
                ...
                <ListItem className={`${(tabValue == '4') ? 'highlightTab text-primary' : ''}`} disablePadding sx={{ display: 'block' }} onClick={() => handleDrawerLinks("4")}>
                  <ListItemButton sx={{ minHeight: 48, justifyContent: open ? 'initial' : 'center', px: 1.5 }}>
                    <ListItemIcon sx={{ minWidth: 0, mr: open ? 2 : 'auto', justifyContent: 'center' }}>
                      <InsuranceOutlined className={`${(tabValue == '4') ? 'text-primary' : ''}`} />
                    </ListItemIcon>
                    <ListItemText primary='Insurance Type' sx={{ opacity: open ? 1 : 0 }} />
                  </ListItemButton>
                </ListItem>
                <ListItem className={`${(tabValue == '5') ? 'highlightTab text-primary' : ''}`} disablePadding sx={{ display: 'block' }} onClick={() => handleDrawerLinks("5")}>
                  <ListItemButton sx={{ minHeight: 48, justifyContent: open ? 'initial' : 'center', px: 1.5 }}>
                    <ListItemIcon sx={{ minWidth: 0, mr: open ? 2 : 'auto', justifyContent: 'center' }}>
                      <UsergroupAddOutlined className={`${(tabValue == '5') ? 'text-primary' : ''}`} />
                    </ListItemIcon>
                    <ListItemText primary='Customers' sx={{ opacity: open ? 1 : 0 }} />
                  </ListItemButton>
                </ListItem>
                <ListItem className={`${(tabValue == '6') ? 'highlightTab text-primary' : ''}`} disablePadding sx={{ display: 'block' }} onClick={() => handleDrawerLinks("6")}>
                  <ListItemButton sx={{ minHeight: 48, justifyContent: open ? 'initial' : 'center', px: 1.5 }}>
                    <ListItemIcon sx={{ minWidth: 0, mr: open ? 2 : 'auto', justifyContent: 'center' }}>
                      <SettingOutlined className={`${(tabValue == '6') ? 'text-primary' : ''}`} />
                    </ListItemIcon>
                    <ListItemText primary='Settings' sx={{ opacity: open ? 1 : 0 }} />
                  </ListItemButton>
                </ListItem>
                <ListItem className={`${(tabValue == '7') ? 'highlightTab text-primary' : ''}`} disablePadding sx={{ display: 'block' }} onClick={() => handleDrawerLinks("7")}>
                  <ListItemButton sx={{ minHeight: 48, justifyContent: open ? 'initial' : 'center', px: 1.5 }}>
                    <ListItemIcon sx={{ minWidth: 0, mr: open ? 2 : 'auto', justifyContent: 'center' }}>
                      <QuestionCircleOutlined className={`${(tabValue == '7') ? 'text-primary' : ''}`} />
                    </ListItemIcon>
